        ...
        defaults = {
          ...
          CustomUserPreferences = {
            ...
            "com.apple.finder" = {
              ...
              NewWindowTargetPath = "file:///Users/${config.host.user.name}/";
            ...
            "/Users/${config.host.user.name}/Library/Preferences/ByHost/com.apple.controlcenter".BatteryShowPercentage =
              true;
            # Privacy
