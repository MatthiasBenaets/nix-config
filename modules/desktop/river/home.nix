  ...
  home.file = {
    ".config/river/init" = {
      ...
      text = ''
        ...
        riverctl map normal Super J focus-view next                                                 # Focus next layout stack
        riverctl map normal Super K focus-view previous                                             # Focus previous layout stack

        riverctl map normal Super+Shift J swap next                                                 # Swap focused view with the next view in layout stack
        riverctl map normal Super+Shift K swap previous                                             # Swap focused view with the previous view in layout stack
