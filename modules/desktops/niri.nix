    ...
    home-manager.users.${vars.user} =
      {
        ...
        xdg.configFile."niri/config.kdl".text = ''
          ...
          input {
              keyboard {
                  xkb {
                      ...
                      // For example:
                      // l"noctalia-shell" "ipc" "call" "launcher" "toggle"ayout "us,ru"
          ...
          spawn-at-startup "${pkgs.swayidle}/bin/swayidle" "-w" "timeout" "300" "noctalia-shell ipc call lockScreen lock" "before-sleep" "noctalia-shell ipc call lockScreen lock"
          ...
          binds {
              ...
              Mod+E hotkey-overlay-title="Files" { spawn "thunar"; }
