#+title: Tom's Nix-Darwin (& hopefully soon NixOS) System Configuration Flake
#+description: General information about my flake and how to set it up
#+author: Matthias Benaets (Forked by Tom Meadows)
...
This flake currently has *4* hosts for NixOS
 1. desktop
...
* Nix-Darwin Installation Guide (Only part being used by Tom currently)
This flake currently has *1* host
  1. macbook
