...
* System Components
|                 | *NixOS - Wayland* | *NixOS - Xorg*    | *Darwin*          | *NixOS - Other*     |
|-----------------+-------------------+-------------------+-------------------+---------------------|
| *Shell*         | Zsh               | Zsh               | Zsh               | Zsh                 |
| *DM*            | GDM               | LightDM           | /                 | TTY1 Login          |
| *WM/DE*         | Gnome             | Bspwm             | Yabai             | Hyprland/River/Sway |
| *Compositor*    | Mutter            | Picom (jonaburg)  | /                 | Hyprland/River/Sway |
| *Bar*           | Dock-to-Panel     | Polybar           | /                 | Waybar              |
| *Hotkeys*       | /                 | Sxhkd             | Skhd              | Hyprland/River/Sway |
| *Launcher*      | Gnome             | Rofi              | /                 | Rofi                |
| *GTK Theme*     | Dracula           | Dracula           | /                 | Dracula             |
| *Notifications* | Gnome             | Dunst             | /                 | Dunst               |
| *Terminal*      | Alacritty         | Alacritty         | Alacritty         | Alacritty           |
| *Editor*        | Nvim + Doom Emacs | Nvim + Doom Emacs | Nvim + Doom Emacs | Nvim + Doom Emacs   |
