...
|-----------------+-------------------+------------------------+------------------+-------------------------|
| *DM*            | /                 | GDM                    | LightDM          | /                       |
| *WM/DE*         | Hyprland          | Gnome                  | Bspwm            | HyprSpace               |
| *Compositor*    | Hyprland          | Mutter                 | Picom (jonaburg) | /                       |
| *Bar*           | Noctalia          | /                      | Polybar          | /                       |
| *Hotkeys*       | Hyprland          | /                      | Sxhkd            | Raycast                 |
| *Launcher*      | Noctalia          | Gnome                  | Rofi             | Raycast                 |
| *GTK Theme*     | Seti              | Adwaita                | Orchis-Dark      | /                       |
| *Notifications* | Noctalia          | Gnome                  | Dunst            | /                       |
| *Terminal*      | Kitty             | Kitty                  | Kitty            | Kitty                   |
| *Used by host*  | Beelink           | Work                   | VM               | MacBook{Intel, AirM1, AirM3} |
